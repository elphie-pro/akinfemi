<template>
    <div class="bg-[#263238] text-[#f4f4f4] border-b-3 border-black overflow-hidden">
        <div :class="pathname === '/projects' ? 'w-full block min-w-[90rem] mx-auto px-4 py-4 md:py-6 pb-0' : 'w-full block lg:max-w-[80rem] md:max-w-[45rem] mx-auto px-4 py-4 md:py-6 pb-0' ">
