<template>
    <div class="overflow-y-hidden md:overflow-hidden">
        <img src="../assets/images/Group 1.svg" alt="" class="absolute w-1/2 xl:w-auto bottom-0 right-0 z-0">
        <img src="../assets/images/Man developer writing programming code.svg" alt="" class="absolute w-1/2 xl:max-w-[15rem]  mt-auto md:-bottom-[3rem] bottom-[-2.5rem] xl:bottom-0 -left-2">
        <img src="../assets/images/Programming using version control in cloud.svg" alt="" class="absolute w-1/2 xl:max-w-[15rem] xl:min-w-[20rem] mt-[10rem] xl:mt-auto top-0 right-0">
