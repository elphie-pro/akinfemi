<template>
    <div class="overflow-y-hidden md:overflow-hidden">
        ...
        <img src="../assets/images/Man developer writing programming code.svg" alt="" class="absolute w-1/2 xl:w-auto  mt-auto md:-bottom-[3rem] bottom-[-2.5rem] xl:bottom-0 -left-2">
        <img src="../assets/images/Programming using version control in cloud.svg" alt="" class="absolute w-1/2 xl:w-auto mt-[10rem] xl:mt-auto top-0 right-0">
