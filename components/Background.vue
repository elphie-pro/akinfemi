<template>
    <div class="overflow-y-hidden md:overflow-hidden">
        <img src="../assets/images/Group 1.svg" alt="" class="absolute w-[10rem] md:w-[18rem] xl:w-auto bottom-0 right-0 z-0">
        <img src="../assets/images/Man developer writing programming code.svg" alt="" class="absolute w-[10rem] md:w-[18rem] xl:w-auto  mt-auto md:-bottom-[3rem] bottom-[-2.5rem] xl:bottom-0 -left-2">
        <img src="../assets/images/Programming using version control in cloud.svg" alt="" class="absolute w-[9rem] md:w-[16rem] xl:w-auto mt-[10rem] xl:mt-auto top-0 right-0">
        <div class="md:w-[6rem] w-[4rem]  absolute">
            <div class="flex flex-col gap-4 items-center">
                <div class="w-[.1rem] md:h-[8rem] h-[4rem] bg-[#000] xl:mt-[5rem] md:mt-[12rem] mt-[9rem]"></div>
