...
const projects = [
    {
        ...
        description:'The Akinfemi project is a modern portfolio that showcases personal projects and technical skills through an interactive, animated interface featuring a project gallery with Project.vue:6 SpotlightCard components that display seven different applications including "Akinfemi V1", "ElphBank", "ElphBlog V1", and others Project.vue:61-133 , sophisticated text animations through the DecryptedText.vue:77-81 DecryptedText component with character-by-character decryption effects, a responsive navigation system with Navbar.vue:8-16 route-aware styling, and a component-driven architecture that follows Nuxt.js file-based routing conventions with modular components for spotlight cards, animated text, and project displays, all built using Vue.js 3, Tailwind CSS, and @vueuse/motion for animations with server-side rendering capabilities.',
